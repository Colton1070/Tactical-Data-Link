...
//	        Print(string.Format("TDL_CONTROLLER: Registered with player ID %1", realPlayerId), LogLevel.NORMAL);
//	    }
...
//	    Print(string.Format("TDL_CONTROLLER: Client registering with player ID %1", playerId), LogLevel.NORMAL);
//	}
